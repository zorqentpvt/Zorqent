        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4 animate-fadeInUp stagger-1">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-2xl font-black text-indigo-700">Z</span>
              </div>
              <span className="text-2xl font-bold gradient-text-blue">Zorqent</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              A passionate team of young developers from Kerala, India, building innovative digital solutions for clients worldwide.
            </p>
          ...
          <div className="animate-fadeInUp stagger-4">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:zorqent@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300 text-sm flex items-start group">
                  <svg className="w-5 h-5 mr-3 mt-0.5 text-indigo-500 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="text-gray-400 text-sm flex items-start">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {currentYear} Zorqent. All rights reserved. Crafted with passion in Kerala 🌴
            </p>
